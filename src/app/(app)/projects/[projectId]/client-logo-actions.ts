 ...
 */
export async function uploadClientLogo(projectId: string, organizationId: string, formData: FormData) {
 ...
 * Remove client logo
 */
export async function removeClientLogo(projectId: string) {
    const supabase = await createClient()
