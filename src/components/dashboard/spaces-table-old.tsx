...
export function SpacesTable({ projects }: SpacesTableProps) {
                        ...
                        {sortedAndFilteredProjects.map((project) => (
                            <TableRow key={project.id} className="cursor-pointer hover:bg-muted/5 border-b last:border-0">
                                <TableCell className="font-mono text-xs p-0">
                                    <Link href={`/dashboard/spaces/${project.id}`} className="block py-3 px-3">
                                        {project.id}
                                    </Link>
                                </TableCell>
                                ...
                                <TableCell className="text-sm p-0">
                                    <Link href={`/dashboard/spaces/${project.id}`} className="flex items-center gap-2 py-3 px-3">
